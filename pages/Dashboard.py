...
uploaded_file = st.file_uploader(
    ...
    type="csv",
    help="Upload a CSV with columns like hazard_type, severity, location, date, etc.",
)
...
if uploaded_file is not None:
    try:
        ...
        # AI Insights section (static placeholder)
        ...
        st.info(
            "Ensure your CSV has columns like: hazard_type, severity, location, date"
        )
